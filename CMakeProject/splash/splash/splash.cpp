#include "IncludeBitmapImage.hpp"
#include "splash/include/splash/Splash.hpp"
...
int main(int argc, char* argv[]) {
    ...
    for (size_t x = 0; x < rawImage.width(); x++) {
        for (size_t y = 0; y < rawImage.height(); y++) {
            ...
            Splash::Colour colour = Splash::Colour(255, pixel.red, pixel.green, pixel.blue);// set r g b时 就进行了value的计算
